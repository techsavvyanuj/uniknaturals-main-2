...
export default function RosewaterBlog() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 pt-32 md:pt-36">
      ...
      <Image src="/videos/rosewater123.png" alt="Rosewater" width={800} height={400} className="w-full h-72 md:h-96 object-contain rounded-lg mb-6 bg-white p-4" priority />
